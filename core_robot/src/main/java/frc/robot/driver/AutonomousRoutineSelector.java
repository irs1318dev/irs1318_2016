...
public class AutonomousRoutineSelector
{
    ...
    private IDigitalInput dipSwitchA;
    private IDigitalInput dipSwitchB;
    private IDigitalInput dipSwitchC;
        ...
        IRobotProvider provider)
    {
        ...
        this.dipSwitchA = provider.getDigitalInput(ElectronicsConstants.AUTONOMOUS_DIP_SWITCH_A);
        this.dipSwitchB = provider.getDigitalInput(ElectronicsConstants.AUTONOMOUS_DIP_SWITCH_B);
        this.dipSwitchC = provider.getDigitalInput(ElectronicsConstants.AUTONOMOUS_DIP_SWITCH_C);
    }
    ...
    public IControlTask selectRoutine()
    {
        ...
        this.logger.logInteger(AutonomousRoutineSelector.LogName, "selection", routineSelection);
