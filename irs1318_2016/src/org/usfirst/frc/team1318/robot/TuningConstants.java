...
public class TuningConstants
{
    ...
    public static final double SHOOTER_CLOSE_SHOT_VELOCITY = 0.7; // 0.55
    public static final double SHOOTER_MIDDLE_SHOT_VELOCITY = 0.45;
    public static final double SHOOTER_FAR_SHOT_VELOCITY = 0.55;
